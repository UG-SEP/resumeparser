...
class ResumeFilterSerializer(serializers.Serializer):
    ...
    full_time_experience = serializers.IntegerField(required=False, allow_null=True,help_text="Full time experience after graduation. ex. 3")
    ...
    product_company_experience = serializers.BooleanField(required=False, allow_null=True,help_text="Product company experience. ex. 3")
    startup_experience = serializers.BooleanField(required=False, allow_null=True,help_text="Startup experience. ex. 3")
    ...
    gen_ai_experience = serializers.BooleanField(required=False, allow_null=True,help_text="No. of years of experience in generative AI. Ex. 5")
    ...
    early_stage_startup_experience = serializers.BooleanField(required=False, allow_null=True,help_text="Early age startup experience. Ex. 3")
    ...
    service_company_experience = serializers.BooleanField(required=False, allow_null=True,help_text="No. of years of experience in service based company. ex. 3")
